...
@Entity(tableName = "Multiplication",
foreignKeys = {
...
public class Multiplication extends Calculation {
    ...
    public Multiplication(String m_s_chapterName, String m_s_courseName, int m_i_rangeMinOperand1, int m_i_rangeMaxOperand1, int m_i_rangeMinOperand2, int m_i_rangeMaxOperand2) {
    ...
    public String getM_s_subject() {
        return m_d_operand1 + " x " + m_d_operand2 + " =";
    }
